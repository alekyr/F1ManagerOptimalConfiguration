...
% 
%     m  n                              n
% J = ? (?(Component(i).Attribute(j)) - ?(Component(i).MaxValueofAttribute(j)))
%     j  i                              i
% 
...
% Objective
y = (total_power - total_max_power)^2 ...
  + (total_aero - total_max_aero)^2 ...
  + (total_grip - total_max_grip)^2 ...
  + (total_reliability - total_max_reliability)^2 ...
  + (total_averagepitstoptime - total_min_averagepitstoptime)^2;
